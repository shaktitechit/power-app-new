...
import type { LightingAuditRecord, LightingAuditDocument } from "@/store/slices/electrical-audit/lightingAuditApiSlice";
...
import { auditToForm, formatDisplayValue, toDateInput } from "./lighting-audit-utils";
...
type Props = {
  ...
  onPreviewDocument: (doc: LightingAuditDocument, recordId: string, index: number) => void;
  onDeleteDocument?: (doc: LightingAuditDocument, recordId: string, index: number) => void;
};

export function LightingAuditDisplayCard({ record, tabLabel, auditStepLocked = false, canDelete = false, canViewDocuments = true, saving = false, onEdit, onDelete, onToggleCompleteness, togglingCompleteness = false, onUploadDocuments, onPreviewDocument, onDeleteDocument }: Props) {
