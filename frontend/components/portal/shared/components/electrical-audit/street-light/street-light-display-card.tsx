...
type Props = {
  ...
  onDeleteDocument?: (doc: StreetLightAuditDocument, recordId: string, index: number) => void;
};

export function StreetLightAuditDisplayCard({ record, tabLabel, auditStepLocked = false, canDelete = false, canViewDocuments = true, saving = false, onEdit, onDelete, onToggleCompleteness, togglingCompleteness = false, onUploadDocuments, onPreviewDocument, onDeleteDocument }: Props) {
