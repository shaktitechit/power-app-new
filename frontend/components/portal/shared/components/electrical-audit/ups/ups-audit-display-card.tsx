...
type Props = {
  ...
  onDeleteDocument?: (doc: UPSAuditDocument, recordId: string, index: number) => void;
};

export function UPSAuditDisplayCard({ record, tabLabel, auditStepLocked = false, canDelete = false, canViewDocuments = true, saving = false, onEdit, onDelete, onToggleCompleteness, togglingCompleteness = false, onUploadDocuments, onPreviewDocument, onDeleteDocument }: Props) {
