...
export function TransformerAuditPanel({
  ...
  const { completenessTargetId, handleToggleCompleteness } =
    useAuditRecordCompletenessToggle(updateTransformerAuditRecord);
        ...
        <DialogContent className="sm:max-w-[520px]">
          ...
          <div className="space-y-4 py-2">
            <div
              ...
              onClick={() =>
                document.getElementById("transformer-audit-doc-file-input")?.click()
              }
            >
              ...
              <input
                id="transformer-audit-doc-file-input"
                type="file"
                multiple
                accept="image/*,.pdf"
                className="hidden"
                ...
                {uploadFiles.map((item) => (
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      <Label htmlFor={`transformer-audit-doc-caption-${item.id}`}>
                        Caption
                      </Label>
                      <Input
                        id={`transformer-audit-doc-caption-${item.id}`}
                        value={item.caption}
                        onChange={(e) =>
                          setUploadFiles((prev) =>
                            prev.map((entry) =>
