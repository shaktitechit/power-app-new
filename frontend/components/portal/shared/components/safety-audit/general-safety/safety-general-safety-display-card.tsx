...
interface SafetyGeneralSafetyDisplayCardProps {
...
export function SafetyGeneralSafetyDisplayCard({
  record,
  recordIndex,
  ...
  onUploadDocuments,
  onPreviewDocument,
}: SafetyGeneralSafetyDisplayCardProps) {
  return (
