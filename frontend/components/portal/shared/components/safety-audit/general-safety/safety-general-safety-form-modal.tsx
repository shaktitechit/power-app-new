...
import type { ChecklistRow, SafetyGeneralSafetyFormState } from "./general-safety-section";
...
type Props = {
  ...
  form: SafetyGeneralSafetyFormState | null;
  onFormChange: (
    updater: (prev: SafetyGeneralSafetyFormState) => SafetyGeneralSafetyFormState,
  ) => void;
  onSave: () => void;
  saving?: boolean;
};

export function SafetyGeneralSafetyFormModal({
  open,
  onOpenChange,
  form,
  onFormChange,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-5xl">
        <DialogHeader>
          <DialogTitle>
            {form.isNew
              ? "Add General Safety Audit"
              : "Edit General Safety Audit"}
          </DialogTitle>
        </DialogHeader>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  onFormChange((f) => ({
                    ...f,
                    status: e.target.value as SafetyGeneralSafetyFormState["status"],
                  }))
                }
              >
