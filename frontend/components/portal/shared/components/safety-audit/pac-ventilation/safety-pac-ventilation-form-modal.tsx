...
type Props = {
  ...
  form: SafetyPacVentilationFormState | null;
  onFormChange: (
    updater: (prev: SafetyPacVentilationFormState) => SafetyPacVentilationFormState,
  ) => void;
  onSave: () => void;
  saving?: boolean;
  unitTypeOptions: { value: UnitType; label: string }[];
};

export function SafetyPacVentilationFormModal({
  open,
  onOpenChange,
  form,
  onFormChange,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-5xl">
        <DialogHeader>
          <DialogTitle>
            {form.isNew
              ? "Add PAC & Ventilation Safety Audit"
              : "Edit PAC & Ventilation Safety Audit"}
          </DialogTitle>
        </DialogHeader>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, unit_name: e.target.value }))
                }
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  onFormChange((f) => ({
                    ...f,
                    status: e.target.value as SafetyPacVentilationFormState["status"],
                  }))
                }
              >
