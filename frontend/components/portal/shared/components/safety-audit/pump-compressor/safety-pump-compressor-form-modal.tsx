...
type Props = {
  ...
  form: SafetyPumpCompressorFormState | null;
  onFormChange: (
    updater: (prev: SafetyPumpCompressorFormState) => SafetyPumpCompressorFormState,
  ) => void;
  onSave: () => void;
  saving?: boolean;
...
export function SafetyPumpCompressorFormModal({
  open,
  onOpenChange,
  form,
  onFormChange,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-5xl">
        <DialogHeader>
          <DialogTitle>
            {form.isNew
              ? "Add Pump & Compressor Safety Audit"
              : "Edit Pump & Compressor Safety Audit"}
          </DialogTitle>
        </DialogHeader>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  onFormChange((f) => ({
                    ...f,
                    status: e.target.value as SafetyPumpCompressorFormState["status"],
                  }))
                }
              >
