...
import { formatEquipmentTypeLabel } from "./pump-compressor-section";

interface SafetyPumpCompressorDisplayCardProps {
...
export function SafetyPumpCompressorDisplayCard({
  record,
        ...
        <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
          <div>
            ...
            <p className="mt-1 text-sm font-medium text-foreground">
              {formatEquipmentTypeLabel(record.equipment_type)}
            </p>
          </div>
          <div>
