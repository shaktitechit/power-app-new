...
type Props = {
  ...
  form: SafetyEarthingSystemFormState | null;
  onFormChange: (
    updater: (prev: SafetyEarthingSystemFormState) => SafetyEarthingSystemFormState,
  ) => void;
  onSave: () => void;
  saving?: boolean;
  pitTypeOptions: { value: PitType; label: string }[];
};

export function SafetyEarthingSystemFormModal({
  open,
  onOpenChange,
  form,
  onFormChange,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-5xl">
        <DialogHeader>
          <DialogTitle>
            {form.isNew
              ? "Add Earthing System Safety Audit"
              : "Edit Earthing System Safety Audit"}
          </DialogTitle>
        </DialogHeader>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div>
              ...
              <Input
                ...
                value={form.pit_name}
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, pit_name: e.target.value }))
                }
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, resistance_ohm: e.target.value }))
                }
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, test_date: e.target.value }))
                }
              />
            </div>
            <div>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  onFormChange((f) => ({
                    ...f,
                    status: e.target.value as SafetyEarthingSystemFormState["status"],
                  }))
                }
              >
