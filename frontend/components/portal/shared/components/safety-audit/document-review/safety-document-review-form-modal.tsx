...
import type {
  ChecklistRow,
  SafetyDocumentReviewFormState,
} from "./document-review-section";
...
type Props = {
  ...
  form: SafetyDocumentReviewFormState | null;
  onFormChange: (
    updater: (prev: SafetyDocumentReviewFormState) => SafetyDocumentReviewFormState,
  ) => void;
  onSave: () => void;
  saving?: boolean;
};

export function SafetyDocumentReviewFormModal({
  open,
  onOpenChange,
  form,
  onFormChange,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-5xl">
        <DialogHeader>
          <DialogTitle>
            {form.isNew
              ? "Add Documents Review Safety Audit"
              : "Edit Documents Review Safety Audit"}
          </DialogTitle>
        </DialogHeader>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  onFormChange((f) => ({
                    ...f,
                    status: e.target.value as SafetyDocumentReviewFormState["status"],
                  }))
                }
              >
