...
type Props = {
  ...
  form: SafetyLeakInspectionFormState | null;
  onFormChange: (
    updater: (prev: SafetyLeakInspectionFormState) => SafetyLeakInspectionFormState,
  ) => void;
  onSave: () => void;
  saving?: boolean;
  equipmentTypeOptions: { value: EquipmentType; label: string }[];
};

export function SafetyLeakInspectionFormModal({
  open,
  onOpenChange,
  form,
  onFormChange,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-5xl">
        <DialogHeader>
          <DialogTitle>
            {form.isNew
              ? "Add Leak Inspection Safety Audit"
              : "Edit Leak Inspection Safety Audit"}
          </DialogTitle>
        </DialogHeader>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, equipment_name: e.target.value }))
                }
            ...
            <div>
              ...
              <select
                className={nativeSelectClassForm(false)}
                value={form.leakage_found}
                onChange={(e) =>
                  onFormChange((f) => ({
                    ...f,
                    leakage_found: e.target.value as "true" | "false",
                  }))
                }
              >
                {LEAKAGE_FOUND_OPTIONS.map((o) => (
                  <option key={o.value} value={o.value}>
                    {o.label}
                  </option>
                ))}
            ...
            <div className="sm:col-span-2">
              ...
              <Textarea
                ...
                value={form.remarks}
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, remarks: e.target.value }))
                }
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  onFormChange((f) => ({
                    ...f,
                    status: e.target.value as SafetyLeakInspectionFormState["status"],
                  }))
                }
              >
