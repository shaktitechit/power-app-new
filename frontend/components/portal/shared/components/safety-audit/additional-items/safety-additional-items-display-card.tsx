...
interface SafetyAdditionalItemsDisplayCardProps {
...
export function SafetyAdditionalItemsDisplayCard({
  record,
              ...
              <tbody>
                {record.items?.map((item, idx) => (
                  <tr key={idx} className="border-b last:border-0 hover:bg-muted/10">
                    ...
                    <td className="p-2 text-muted-foreground whitespace-pre-line">
                      {item.requirement || "-"}
                    </td>
