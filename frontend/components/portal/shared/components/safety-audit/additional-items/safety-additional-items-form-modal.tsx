...
type Props = {
  ...
  form: SafetyAdditionalItemsFormState | null;
  onFormChange: (
    updater: (prev: SafetyAdditionalItemsFormState) => SafetyAdditionalItemsFormState,
  ) => void;
  onSave: () => void;
  saving?: boolean;
};

export function SafetyAdditionalItemsFormModal({
  open,
  onOpenChange,
  form,
  onFormChange,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-5xl">
        <DialogHeader>
          <DialogTitle>
            {form.isNew
              ? "Add Additional Items Safety Audit"
              : "Edit Additional Items Safety Audit"}
          </DialogTitle>
        </DialogHeader>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, area_name: e.target.value }))
                }
                placeholder="e.g. Ward B corridor"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  onFormChange((f) => ({
                    ...f,
                    status: e.target.value as SafetyAdditionalItemsFormState["status"],
                  }))
                }
              >
