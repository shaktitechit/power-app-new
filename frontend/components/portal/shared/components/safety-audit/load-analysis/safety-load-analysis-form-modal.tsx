...
import type { ChecklistRow, SafetyLoadAnalysisFormState } from "./load-analysis-section";
...
type Props = {
  ...
  form: SafetyLoadAnalysisFormState | null;
  onFormChange: (
    updater: (prev: SafetyLoadAnalysisFormState) => SafetyLoadAnalysisFormState,
  ) => void;
  onSave: () => void;
  saving?: boolean;
};

export function SafetyLoadAnalysisFormModal({
  open,
  onOpenChange,
  form,
  onFormChange,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-5xl">
        <DialogHeader>
          <DialogTitle>
            {form.isNew
              ? "Add Load Analysis Safety Audit"
              : "Edit Load Analysis Safety Audit"}
          </DialogTitle>
        </DialogHeader>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  onFormChange((f) => ({
                    ...f,
                    status: e.target.value as SafetyLoadAnalysisFormState["status"],
                  }))
                }
              >
