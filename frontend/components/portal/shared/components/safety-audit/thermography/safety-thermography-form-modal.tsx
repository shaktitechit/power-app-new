...
import type { ChecklistRow, SafetyThermographyFormState } from "./thermography-section";
...
type Props = {
  ...
  form: SafetyThermographyFormState | null;
  onFormChange: (
    updater: (prev: SafetyThermographyFormState) => SafetyThermographyFormState,
  ) => void;
  onSave: () => void;
  saving?: boolean;
};

export function SafetyThermographyFormModal({
  open,
  onOpenChange,
  form,
  onFormChange,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-5xl">
        <DialogHeader>
          <DialogTitle>
            {form.isNew
              ? "Add Thermography Safety Audit"
              : "Edit Thermography Safety Audit"}
          </DialogTitle>
        </DialogHeader>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, inspection_date: e.target.value }))
                }
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, inspected_by: e.target.value }))
                }
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, max_temperature_c: e.target.value }))
                }
              />
            </div>
            <div>
              <Label>Delta temperature (°C)</Label>
              <Input
                className={inputClass}
                type="number"
                value={form.delta_temperature_c}
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, delta_temperature_c: e.target.value }))
                }
              />
            </div>
            <div>
              ...
              <select
                ...
                value={form.urgency}
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, urgency: e.target.value }))
                }
              >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  onFormChange((f) => ({
                    ...f,
                    status: e.target.value as SafetyThermographyFormState["status"],
                  }))
                }
              >
