...
type Props = {
  ...
  form: SafetyElevatorSafetyFormState | null;
  onFormChange: (
    updater: (prev: SafetyElevatorSafetyFormState) => SafetyElevatorSafetyFormState,
  ) => void;
  onSave: () => void;
  saving?: boolean;
};

export function SafetyElevatorSafetyFormModal({
  open,
  onOpenChange,
  form,
  onFormChange,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-5xl">
        <DialogHeader>
          <DialogTitle>
            {form.isNew
              ? "Add Elevator Safety Audit"
              : "Edit Elevator Safety Audit"}
          </DialogTitle>
        </DialogHeader>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, elevator_name: e.target.value }))
                }
                placeholder="e.g. Passenger Lift A"
              />
            </div>
            <div>
              ...
              <Input
                ...
                placeholder="Building / floor / shaft"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  onFormChange((f) => ({
                    ...f,
                    status: e.target.value as SafetyElevatorSafetyFormState["status"],
                  }))
                }
              >
