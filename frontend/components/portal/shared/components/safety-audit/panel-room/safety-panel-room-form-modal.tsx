...
type Props = {
  ...
  form: SafetyPanelRoomFormState | null;
  onFormChange: (
    updater: (prev: SafetyPanelRoomFormState) => SafetyPanelRoomFormState,
  ) => void;
  onSave: () => void;
  saving?: boolean;
  panelTypeOptions: { value: PanelType; label: string }[];
};

export function SafetyPanelRoomFormModal({
  open,
  onOpenChange,
  form,
  onFormChange,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-5xl">
        <DialogHeader>
          <DialogTitle>
            {form.isNew
              ? "Add Panel Room Safety Audit"
              : "Edit Panel Room Safety Audit"}
          </DialogTitle>
        </DialogHeader>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, panel_name: e.target.value }))
                }
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  onFormChange((f) => ({
                    ...f,
                    status: e.target.value as SafetyPanelRoomFormState["status"],
                  }))
                }
              >
