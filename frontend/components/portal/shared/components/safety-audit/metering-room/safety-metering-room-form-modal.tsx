...
import type { ChecklistRow, SafetyMeteringRoomFormState } from "./metering-room-section";
...
type Props = {
  ...
  form: SafetyMeteringRoomFormState | null;
  onFormChange: (
    updater: (prev: SafetyMeteringRoomFormState) => SafetyMeteringRoomFormState,
  ) => void;
  onSave: () => void;
  saving?: boolean;
...
export function SafetyMeteringRoomFormModal({
  open,
  onOpenChange,
  form,
  onFormChange,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-5xl">
        <DialogHeader>
          <DialogTitle>
            {form.isNew
              ? "Add Metering Room Safety Audit"
              : "Edit Metering Room Safety Audit"}
          </DialogTitle>
        </DialogHeader>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  onFormChange((f) => ({
                    ...f,
                    status: e.target.value as SafetyMeteringRoomFormState["status"],
                  }))
                }
              >
