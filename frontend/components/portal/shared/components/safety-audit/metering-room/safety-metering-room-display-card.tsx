...
interface SafetyMeteringRoomDisplayCardProps {
...
export function SafetyMeteringRoomDisplayCard({
  record,
  recordIndex,
  ...
  onUploadDocuments,
  onPreviewDocument,
}: SafetyMeteringRoomDisplayCardProps) {
  return (
