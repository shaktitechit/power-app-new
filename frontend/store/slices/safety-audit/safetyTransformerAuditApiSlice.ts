...
const base = "/v1/safety-transformer-audits";
const tag = "SafetyTransformerAudit" as const;

export const safetyTransformerAuditApiSlice = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    getSafetyTransformerAudits: builder.query<ListSafetyAuditsResponse, SafetyAuditListArg>({
      query: (params) => ({
        url: base,
        method: "GET",
    ...
    getSafetyTransformerAuditById: builder.query<GetSafetyAuditByIdResponse, string>({
      query: (id) => ({ url: `${base}/${id}`, method: "GET" }),
      providesTags: (_r, _e, id) => [{ type: tag, id }],
    }),
    createSafetyTransformerAudit: builder.mutation<
      MutateSafetyAuditResponse,
      CreateSafetyAuditRequest
    >({
      query: (body) => ({
    ...
    updateSafetyTransformerAudit: builder.mutation<
      MutateSafetyAuditResponse,
      UpdateSafetyAuditRequest
    >({
      query: ({ id, ...body }) => ({
    ...
    deleteSafetyTransformerAudit: builder.mutation<DeleteSafetyAuditResponse, string>({
